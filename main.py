...
def insert_info(dict):
    ...
    if dict_baza != {}:
        ...
        phone1 = dict_baza['8']
        phone2 = dict_baza['9']
        db.execute('INSERT INTO MarketInfo VALUES (:name, :address, :address2,:bank,  :data1,  :data2,  :data3,  :phone1, :phone2)', {
                'name': name,
                'address': address,
                'address2': address2,
                'bank': bank,
...
eel.start('main1.html', size=(Width, Height), port=8080,cmdline_args=['--fullscreen'] )