...
async function update_data_info() {
    let get_data = await eel.get_info()()
    dict = {
    ...
    if (get_data == 0) {
        eel.insert_info(dict)
         info_table_name.value = ''
         info_table_address1.value = ''
         info_table_address2.value = ''
         info_table_bank.value = ''
         info_table_data1.value = ''
         info_table_inn.value = ''
         info_table_data3.value = ''
         info_table_phone1.value = ''
         info_table_phone2.value = ''
        insert_info_data()
    }
    else {
